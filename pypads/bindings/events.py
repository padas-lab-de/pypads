...
DEFAULT_LOGGING_FNS = {
    ...
    "hardware": [Cpu(_pypads_write_format=WriteFormats.text.name), Ram(_pypads_write_format=WriteFormats.text.name),
                 Disk(_pypads_write_format=WriteFormats.text.name)],
    "metric": Metric(),
